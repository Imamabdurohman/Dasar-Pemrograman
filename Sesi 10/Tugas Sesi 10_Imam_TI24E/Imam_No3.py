...
def cari_barang():
    nama_barang = input("Massukan Nama Barang yang dicari: ")
...
def perbarui_stok():
    nama_barang = input("Masukan Nama Barang untuk diperbarui: ")
    if nama_barang in inventory:
        stok_baru = int(input("Masukan Stok Baru: "))
        harga = inventory[nama_barang][0]
        inventory[nama_barang] = (harga, stok_baru)
        print(f"Stok untuk {nama_barang} berhasil diperbarui.")
    else:
        print("Barang tidak ditemukan.")

def hapus_barang():
    nama_barang = input("Masukan Nama Barang yang akan dihapus: ")
    if nama_barang in inventory:
        del inventory[nama_barang]
        print(f"{nama_barang} berhasil dihapus dari inventaris.")
    else:
        print("Barang tidak ditemukan.")
...
def menu_program():
    while True:
        ...
        if pilihan == '7':
            ...
            print("Pilihan tiak valid. Silahkan coba lagi.")
